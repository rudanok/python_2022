# Скрипт взят отсюда: https://github.com/NikitaX007/python_sem_10
# Но не работает из-за отсутствия библиотеки Filters
...
if __name__ == '__main__':
    updater = Updater("5726903819:AAFOFc7ampkKQ81ECUTCXcXbSkANSQEhHSs")
